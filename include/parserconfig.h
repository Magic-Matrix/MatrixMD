...
struct ParserConfig
{
   ...
   *
   * this flag = false == `enabledParsers &= ~matrix::markdown::parser::types::EMPHASIZED_PARSER`
  */
   ...
   * @deprecated will be removed in 1.4.0 latest
   *
   * this flag = false == `enabledParsers |= matrix::markdown::parser::types::HTML_PARSER`
  */
  ...
  */
  ...
  ParserConfig()
    ...
    , enabledParsers(matrix::markdown::parser::types::DEFAULT)
  {}
}; // class ParserConfig
